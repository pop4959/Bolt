...
public class InfoCommand extends BoltCommand {
    ...
    public void shortHelp(CommandSender sender, Arguments arguments) {
        BoltComponents.sendMessage(
                sender,
                Translation.HELP_COMMAND_SHORT_INFO,
                Placeholder.component(Translation.Placeholder.COMMAND, Component.text("/bolt info"))
        );
    }

    @Override
    public void longHelp(CommandSender sender, Arguments arguments) {
        BoltComponents.sendMessage(sender, Translation.HELP_COMMAND_LONG_INFO);
    }
}
